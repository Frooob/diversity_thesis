...
\usepackage[dvipsnames]{xcolor} % Add this in the preamble if not already present

% \newcommand{\rOne}[1]{\textcolor{red}{#1}}
% \newcommand{\rTwo}[1]{\textcolor{blue}{#1}}
% \newcommand{\rThree}[1]{\textcolor{ForestGreen}{#1}}
...
\hypersetup{%
	pdfsubject={Master thesis of Matthias Mildenberger with the goal to investigate the effect of data diversity on image reconstruction from brain activity.},
...
\Supervisor{Yoshihiro Nagano}{Assistant Professor of Neuroinformatics, Kyoto University}
...
\Acceptor{Florentin Wörgötter}{Professor for Computational Neuroscience, University of Göttingen}{} % \\ \> Third title}
...
\DegreeDate{April}{2025}
% May 2025

% Date that final thesis is submitted to department
\ThesisDate{April 28, 2025}
...
%% If you want to use "double spacing", you should start here...
 ...
 \include{content/01_Background}% .tex extension is presumed
 \include{content/02_methodology}
 \include{content/03_experiments}
 \include{content/04_discussion}
% \include{chapter2}
% \include{chapter3}
% \include{chapter4}
